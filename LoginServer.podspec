#
#  Be sure to run `pod spec lint LoginServer.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "http://EXAMPLE/LoginServer.git", :tag => "#{spec.version}" }
